                    ...
                    <div id="inputBtn">
                        ...
                        <div id="inputPath" style="display: none">
                                <form onsubmit="searchPlaces(); return false;" >
                                    <input type="text" class="textBtn" placeholder="출발지 주소를 입력하세요." id="startkeyword" size="15" style="margin-right: 10px;"> 
                                    <button type="submit" class="textBtn" style="display: flex;"></button>
                                    <hr style="width: 82vw; background-color: #fff;">
                                    <input type="text" class="textBtn" value="출발지" id="endkeyword" size="15" style="margin-right: 10px;"> 
...
<script>
    ...
    menuIcon.addEventListener('click', function(event) {
        ...
        sidebarMember.classList.add('show');  // ← 수정됨
    ...
    overlay.addEventListener('click', function () {
        sidebarMember.classList.remove('show');  // ← 수정됨
